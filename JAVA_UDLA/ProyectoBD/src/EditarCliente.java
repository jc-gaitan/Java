...
public class EditarCliente extends javax.swing.JDialog {
    ...
    public EditarCliente(JFrame padre, boolean modal, Conexion conn) {
        super(padre, modal);
    ...
    private void initComponents() {
        ...
        TextDireccion2 = new javax.swing.JTextField();
        TextBarrio2 = new javax.swing.JTextField();
        ...
        jLabel30.setText("Telefono2: ");
        jPanel3.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, -1, -1));

        jLabel31.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel31.setText("Direccion:");
        jPanel3.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 290, -1, -1));

        jLabel32.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel32.setText("Barrio:");
        jPanel3.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, -1, -1));

        jLabel33.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel33.setText("Email:");
        jPanel3.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 350, -1, -1));

        EE.setFont(new java.awt.Font("Tahoma", 1, 8)); // NOI18N
        EE.setText("Editar");
        ...
        jPanel3.add(EE, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 350, -1, -1));
        ...
        jPanel3.add(BCancelar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 390, 160, -1));
        ...
        jPanel3.add(TextDireccion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 290, 140, 23));
        jPanel3.add(TextBarrio2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 320, 140, 23));
        jPanel3.add(TextEmail2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 350, 140, 23));
        ...
        ED.setFont(new java.awt.Font("Tahoma", 1, 8)); // NOI18N
        ED.setText("Editar");
        ...
        jPanel3.add(ED, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 290, -1, -1));

        EB.setFont(new java.awt.Font("Tahoma", 1, 8)); // NOI18N
        EB.setText("Editar");
        ...
        jPanel3.add(EB, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 320, -1, -1));
        ...
        jLabel34.setText("Ingrese el numero de cedula que desea eliminar:");
    ...
    private void EEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EEActionPerformed
        ...
        try {
            CallableStatement cs = conn.prepareCall("{call UpdateClienteEmail(?,?)}");
            cs.setLong(1, Long.parseLong(TextCc2.getText()));
            cs.setString(2, TextEmail2.getText());
            cs.executeQuery();
            cs.close();
            conn.close();
    ...
    private void EDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EDActionPerformed
        Connection conn = Conexion.getConnection();
        try {
            CallableStatement cs = conn.prepareCall("{call UpdateClienteDireccion(?,?)}");
            cs.setLong(1, Long.parseLong(TextCc2.getText()));
            cs.setString(2, TextDireccion2.getText());
            cs.executeQuery();
            cs.close();
            conn.close();
            System.out.println("update.");
    ...
    private void EBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EBActionPerformed
        Connection conn = Conexion.getConnection();
        try {
            CallableStatement cs = conn.prepareCall("{call UpdateClienteBarrio(?,?)}");
            cs.setLong(1, Long.parseLong(TextCc2.getText()));
            cs.setString(2, TextBarrio2.getText());
            cs.executeQuery();
            cs.close();
            conn.close();
            System.out.println("update.");
    ...
    private void jButtonBucasrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBucasrActionPerformed
        try {
            ...
            while (rs.next()) {
                ...
                jTextArea1.setText("  Cedula: " + rs.getString(1) + "\n  Nombre: " + rs.getString(2) + "\n  Apellido: " + rs.getString(3)
    ...
    private javax.swing.JTextField TextBarrio2;
    ...
    private javax.swing.JTextField TextDireccion2;
